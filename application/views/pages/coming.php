  ...
  <body class="nomobile">
    ...
    <section id="header">
        ...
        <div id="slider" class="rev_slider">
            <ul>
              <li data-transition="slideleft" data-slotamount="1" data-thumb="<?php echo base_url();?>assets/img/slider/1.jpg">
                <img src="<?php echo base_url();?>assets/img/slider/1.jpg">
              </li>
              <li data-transition="slideleft" data-slotamount="1" data-thumb="<?php echo base_url();?>assets/img/slider/2.jpg">
                <img src="<?php echo base_url();?>assets/img/slider/2.jpg">
              </li>
              <li data-transition="slideleft" data-slotamount="1" data-thumb="<?php echo base_url();?>assets/img/slider/3.jpg">
                <img src="<?php echo base_url();?>assets/img/slider/3.jpg">
              </li>
              <li data-transition="slideleft" data-slotamount="1" data-thumb="<?php echo base_url();?>assets/img/slider/4.jpg">
    ...
    <script src="<?php echo base_url();?>assets/js/soon/jquery.themepunch.revolution.min.js"></script>
